...
function renderStringNode(open: string,
                          close
...
function renderStringList(val: any,
                          render: (val: any,
...
function renderSSRClass(staticClass: ?string,
                        dynamic: any): string {
    const res = renderClass(staticClass, dynamic)
    return res === '' ? res : ` class="${escape(res)}"`
}

function renderSSRStyle(staticStyle: ?Object,
                        dynamic: any,
                        extra: ?Object): string {
    const style = {}
