...
export function genDOMPropSegments(props: Array<Attr>,
                                   attrs: ?Array<Attr>): Array<StringSegment> {
    const segments = []
...
export function genClassSegments(staticClass: ?string,
                                 classBinding: ?string): Array<StringSegment> {
...
export function genStyleSegments(staticStyle: ?string,
                                 parsedStaticStyle: ?string,
                                 styleBinding: ?string,
                                 vShowExpression: ?string): Array<StringSegment> {
